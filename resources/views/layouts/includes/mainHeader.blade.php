<header class="main-header">
    ...
    <a href="/" class="logo">
        ...
        <span class="logo-lg"><b>Gestion</b>Calidad</span>
    </a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="{{asset('/images/adminLTE-imgs/avatar5.png')}}" class="user-image" alt="User Image">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header" style="height: auto">
                            <img src="{{asset('/images/adminLTE-imgs/avatar5.png')}}" class="img-circle" alt="User Image">
                            <p>
                                {{Auth::user()->name}} - {{Auth::user()->role(Auth::user()->role)}}
                            </p>
                        </li>
                        {{--<!-- Menu Body -->
                        <li class="user-body">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="{{route('usuarios.show',Auth::user()->id)}}" class="btn btn-default btn-flat"><i class="fa fa-user"></i> Profile</a>
                            </div>
